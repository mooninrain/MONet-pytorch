...
class MONetModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.netAttn = networks.init_net(networks.Attention(opt.input_nc, 1,load_size=opt.load_size), gpu_ids=self.gpu_ids)
        self.netCVAE = networks.init_net(networks.ComponentVAE(opt.input_nc, opt.z_dim, load_size=opt.load_size), gpu_ids=self.gpu_ids)
